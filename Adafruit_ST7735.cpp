...
Adafruit_ST7735::Adafruit_ST7735(int8_t cs, int8_t rs, int8_t sid, int8_t sclk, int8_t rst) : WIDTH(ST7735_TFTWIDTH), HEIGHT(ST7735_TFTHEIGHT_18)
{
  _width    = WIDTH;
  _height   = HEIGHT;
  rotation  = 0;
...
Adafruit_ST7735::Adafruit_ST7735(int8_t cs, int8_t rs, int8_t rst) : WIDTH(ST7735_TFTWIDTH), HEIGHT(ST7735_TFTHEIGHT_18)
{
  _width    = WIDTH;
  _height   = HEIGHT;
  rotation  = 0;
...
void Adafruit_ST7735::fillImage(void *image, int x, int y, int w, int h) {
